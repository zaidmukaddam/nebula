import 'dart:io';
import 'package:nebula/Helpers/countrycodes.dart';
import 'package:nebula/CustomWidgets/GradientContainers.dart';
import 'package:nebula/Helpers/picker.dart';
import 'package:nebula/Screens/Top Charts/top.dart' as topScreen;
import 'package:nebula/Screens/Home/trending.dart' as trendingScreen;
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Share.share(
                            'Hey! Check out this cool music player app: https://github.com/zaidmukaddam/nebula');
                      },
                      dense: true,
                    ),
                    ListTile(
                                      ...
                                      children: [
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.pop(context);
                                            launch(
                                                "https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3Dzaidlunatic1%40gmail.com%26subject%3DRegarding%2520Mobile%2520App");
                                          },
                                        ),
                                        Text('Gmail'),
                                      ],
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.pop(context);
                                            launch("https://t.me/zaidmukaddam");
                                          },
                                        ),
                                        Text('Telegram'),
                                      ],
                                      ...
                                      children: [
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.pop(context);
                                            launch(
                                                "https://instagram.com/zaid_mukaddam.cpp");
                                          },
                                        ),
                                        Text('Instagram'),
                                      ],
